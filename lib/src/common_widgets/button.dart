...
GestureDetector myButton(BuildContext context, double width, double hight,
    String text, Widget pageRouter) {
  return GestureDetector(
    onTap: () {
      Navigator.push(
          context, MaterialPageRoute(builder: (BuildContext) => pageRouter));
    },
    child: Container(
      width: width,
      height: hight,
